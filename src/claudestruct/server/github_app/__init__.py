...
# --- PR-open as bot (W6.6) — moved to clone_push.py ------------------
#
# `open_pr_as_bot` (and its private clone/push helpers) lives in
# `clone_push.py`. Re-exported at the bottom of this file so existing
# `from claudestruct.server.github_app import open_pr_as_bot` call
...
# Bottom-of-file re-export: `open_pr_as_bot` lives in clone_push.py
# but existing call sites (worker.py) import it from this package.
# This import happens AFTER mint_app_jwt / get_ref_sha /
# create_pull_request / InstallationTokenCache / GitHubAppConfig are
# all defined above, so clone_push.py's late imports resolve
# against a fully-loaded parent namespace.
from claudestruct.server.github_app.clone_push import open_pr_as_bot as open_pr_as_bot  # noqa: E402, PLC0414, I001
